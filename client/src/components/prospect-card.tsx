    ...
    <>
      ...
      >
        ...
        <div className="flex items-center gap-1.5 flex-wrap">
          ...
          {prospect.workMode && (
            <span className="inline-flex items-center text-xs font-medium text-muted-foreground" data-testid={`text-work-mode-${prospect.id}`}>
              · {prospect.workMode}
            </span>
          )}
          {prospect.salary && (
            <span className="text-xs font-medium text-emerald-600 dark:text-emerald-400" data-testid={`text-salary-${prospect.id}`}>
              {prospect.salary}
            </span>
          )}
        </div>
